...
// Function that accepts a string value as an arguement and returns a random index number from that string
function randomIndex(str){
    return Math.floor(Math.random() * str.length);
};
// Check to see if it is functioning properly
console.log(randomIndex('Chicken')); // 0 - 6
...
// Generate Password Function (Function that accepts true or false values as an argument)
...
clipboardEl.addEventListener('click', () => {
    ...
    // Referencing the navigator object to copy the selected value to the clipboard on the device webpage is being viewed on
